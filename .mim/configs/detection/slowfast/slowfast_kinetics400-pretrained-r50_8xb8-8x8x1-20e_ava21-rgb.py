...
data_root = '/nfs20/test-N/lcy/panda/data/frames'
anno_root = '/nfs20/test-N/lcy/panda/data/annotations'

ann_file_train = f'{anno_root}/ava_train.csv'
ann_file_val = f'{anno_root}/ava_val.csv'

exclude_file_train = f'{anno_root}/ava_train_excluded_timestamps.csv'
exclude_file_val = f'{anno_root}/ava_val_excluded_timestamps.csv'

label_file = f'{anno_root}/ava_action_list.pbtxt'
